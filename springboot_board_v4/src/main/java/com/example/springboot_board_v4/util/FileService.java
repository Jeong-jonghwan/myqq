package com.example.springboot_board_v4.util;
...
public class FileService {
	 ...
	 * @return 저장된 파일명
	 */
	public AttechedFile saveFile(MultipartFile mfile) {
		...
		return new AttechedFile(originalFilename, savedFilename + ext);
	}
